                                                        ...
                                                        <tr>
                                                            <td style="padding:4px;">
                                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-radius:3px;width:30px;">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td style="font-size:0;height:30px;vertical-align:middle;width:30px;"> <a href="http://promarket.lv" target="_blank">
                                          <img height="30"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div style="font-family:Lato, sans-serif;font-size:14px;font-weight:bold;line-height:1;text-align:left;color:#126fb8;"> {{__("Dear")}} <div class="big i">{{ $request_details->name }}</div>, </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <td align="left" style="font-size:0px;padding:10px 25px;padding-top:5px;word-break:break-word;">
                                                <table object border="0" style="cellspacing:0;color:#000;font-family:lato, sans-serif;font-size:13px;line-height:22px;table-layout:fixed;width:100%;">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><b>E-pasts:</b></td>
                                                            <td>torsherio@gmail.com</td>
                                                        </tr>
                                                        <tr>
                                                            <td><b>Mobilais tālrunis::</b></td>
                                                            <td>29293410</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table object border="0" style="cellspacing:0;color:#000;font-family:lato, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;">
                                                    <tbody>
                                                        <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:5px 0;">
                                                            <th style="min-width:80px;text-align:left;">Preces kods </th>
                                                            <th style="min-width:80px;text-align:left;">Prece</th>
                                                            <th style="min-width:60px;text-align:left;">Cena</th>
                                                            <th style="min-width:45px;text-align:left;">Skaits</th>
                                                            <th align="right" style="min-width:60px;text-align:right;">Kopā</th>
                                                        </tr>
                                                        <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:5px 0;">
                                                            <td>P904102514</td>
                                                            <td style="padding-right:10px;">2in1 putekļu sūcējs-tvaika slota Bissell Vac &Steam 1977N </td>
                                                            <td>159,95 €</td>
                                                            <td>1</td>
                                                        ...
                                                        <tr>
                                                            <td></td>
                                                            <td></td>
                                                            <td style="border-top:1px solid #555555;" colspan="2"><b>KOPĀ</b></td>
