...
<tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div style="font-family:Lato, sans-serif;font-size:14px;font-weight:bold;line-height:1;text-align:left;color:#126fb8;"> {{__("Dear")}} <div class="big i">{{ $order->fio }}</div>, </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
    ...
    <tr>
        ...
        <td><span>{{__("Product name")}}: {{$detail->name}}</span> </td>
        <td><span>{{__("Price")}}: {{$detail->price}} €</span> </td>
        <td>@isset($detail->color)
            <span>{{__("Color")}}: {{$detail->color['name']}}</span> 
            @endisset</td>
        @endforeach
    </tr>
    <tr>
    ...
    <tr>
        <td><span>{{__("We are waiting for you in our branch")}}:<br> {{$order->address}}</span> </td>
        <td><span>{{__("date")}}:<br> {{$order->created_at}} </span></td>
        <td><span>{{__("total")}}:<br> {{$order->total_amount}}</span></td>
    </tr>
    <tr>
        <td></td>
        <td></td>
    ...
    <tr>
        <td><span>{{__("THANK YOU FOR THE ORDER")}},</span> </td>
        <td><span>{{__("Best regards team")}} Promarket</span></td>
        <td></td>
    </tr>
</tbody>
                                </table>
