...
@section('content')
                ...
                <div class="panel panel-bordered">
                    ...
                    {{--<div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                @php
                                    $colors = DB::table('detail_colors')->where('fixing_detail_id', $dataTypeContent->id)->get();
                                @endphp
                                ...
                                <div class="table-responsive">
                                    <table id="dataTable" class="table table-hover dataTable no-footer" role="grid"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="actions text-right sorting_disabled">
                                                Доступные действия
                                            </th>
                                        </tr>
                                        </thead>
                                        ...
                                        @foreach($colors as $color)
                                            ...
                                            <tr role="row">
                                                ...
                                                <td class="no-sort no-click bread-actions">
                                                    <form action="{{route('delete-detail-color')}}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
                                                    ...
                                                    <a href="{{config('app.url')}}admin/detail-colors/{{$color->id}}/edit"
                            ...
                            <div class="col-lg-6">
                                @php
                                    $qualities = DB::table('detail_qualities')->where('fixing_detail_id', $dataTypeContent->id)->get();
                                @endphp
                                <div class="page-title">
                                    Качества
                                </div>
                                    ...
                                    <table id="dataTable" class="table table-hover dataTable no-footer" role="grid"
                                        ...
                                        @foreach($qualities as $quality)
                                            ...
                                            <tr role="row">
                                                ...
                                                <td>
                                                    <div>{{$quality->cost}}</div>
                                                </td>
                                                <td class="no-sort no-click bread-actions">
                                                    <form action="{{route('delete-detail-quality')}}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
                                                    ...
                                                    <a href="{{config('app.url')}}admin/detail-qualities/{{$quality->id}}/edit"
                                                       class="btn btn-sm btn-primary pull-right"
                                                       target="_blank"
                                                    >
                                                        <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">Изменить</span>
    ...
    <div class="modal fade" id="staticBackdrop2" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="{{route('detail-quality')}}">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Создать качество</h5>
                    ...
                    <div class="modal-body">
                        @csrf
                        <div class="row">
                            <input type="hidden" value="{{$dataTypeContent->id}}" name="fixing_detail_id">
                            <div class="form-group  col-md-12 ">
                                <label class="control-label" for="name">Название детали</label>
                                    <input required="" type="text" class="form-control" name="name"
                                           placeholder="name">
                            </div>
                            <div class="form-group  col-md-12 ">
                                <label class="control-label" for="name">Количество детали</label>
                                <input required="" type="number" class="form-control" name="quantity"
                                       placeholder="quantity">
                            </div>
                            <div class="form-group  col-md-12 ">
                                <label class="control-label" for="name">Цена детали</label>
    ...
    <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            ...
            <form method="POST" action="{{route('detail-color')}}">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Создать цвет</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <input type="hidden" value="{{$dataTypeContent->id}}" name="fixing_detail_id">
                            <div class="form-group  col-md-12 ">
                                <label class="control-label" for="name">Название цвета</label>
                                    <input required="" type="text" class="form-control" name="name"
                                           placeholder="name">

                            </div>
                            <div class="form-group  col-md-12 ">
                                <label class="control-label" for="name">Код цвета</label>
